                    ...
                    items: [
                            {
                                    ...
                                    price: '¥500',
                                    image: '/public/images/strawberry-chocolate.jpg'
                            },
                            {
                                    name: 'クッキーアンドクリーム🍪',
                                    description: 'サクサクのクッキーと濃厚なクリームの絶妙なコンビネーション',
                                    price: '¥500',
                                    image: '/public/images/cookie-and-cream.jpg'
                            },
                            {
                                    name: '抹茶あんこ🍵',
                                    description: '濃厚な抹茶と甘さ控えめのあんこの絶妙なバランス',
                                    price: '¥500',
                                    image: '/public/images/matcha-anko.jpg'
                            }
                    ]
            },
            access: {
    ...
    en: {
            ...
            footer: {
                    address: [
                            ...
                            <br key="4" />,
                            'Building 8, Class 1-2 (3rd floor)',
                            <br key="5" />,
                            '866 Nakane, Hitachinaka-shi',
                            <br key="6" />,
                            'Ibaraki-ken 312-8508'
                    ],
                    copy: [
                            '© Don Crepe 33rd Shikosai Class 1-2'
                    ]
            },
            countdown: {
                    title: '⏳ Countdown',
